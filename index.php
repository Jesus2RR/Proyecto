...
<body>
                ...
                <div class="respmenu">       
                    <nav>
                        <ul>
                            ...
                            <li><a href="app/controller/Perfil.php">Perfil</a></li>
                            <li><a href="app/controller/Calendario.php">Calendario</a></li>
                ...
                <div class="respmenu">       
                    <nav>
                        <ul>
                            ...
                            <li><a href="app/controller/Perfil.php">Perfil</a></li>
                            <li><a href="app/controller/Calendario.php">Calendario</a></li>
                            <li><a href="app/controller/Gestion.php">Configurar Calendario</a></li>
                            <li><a href="app/controller/reservas.php">Reservas</a></li>
                            <li><a href="app/controller/logout.php" class="cerrarSesion">Cerrar sesión</a></li>
                        </ul>
                    </nav>
                </div>
    ...
    <form action="./app/controller/Calendario.php">
