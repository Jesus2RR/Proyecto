...
<body>
    ...
    <div class='center'>
        ...
        <div class='reservar'>
                ...
                if($_POST['tipo'] == 'reservaCC'){
                    ?>
                    <div class='anotacion'>
                        <form action="./citaCorreo.php" method="post">
                            <label for="txtCorreo">Correo</label>
                            <input type="email" name="txtCorreo">

                            <label for="anotacion">Anotacion (opcional)</label>
                ...
                <p>¿Desea añadir alguna anotacion?</p>

                <div class='aceptar'>

                    <form action="./Anotacion.php" method="post">
                        <input type="hidden" name="horaHidden" value='<?php echo $_POST['horaHidden'];?>'>
                        <input type="hidden" name="tipo" value="<?php echo $_POST['tipo'];?>">
